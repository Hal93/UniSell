...
<div id="content">
 ...
 <form name="addcat" enctype="multipart/form-data" method="post" action="addsubcat.php">
  <table border="1" align="center" >
  <tr>
    <td colspan="2">Add New Subcategory</td>
  ...
  <tr>
    ...
    <td> <select name="category" id="category">
                  <?php
			  	$result = mysqli_query($con,"SELECT Name FROM category")
				or die(mysql_error());
